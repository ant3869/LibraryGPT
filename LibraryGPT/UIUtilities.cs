...
namespace LibraryGPT
{
    public static class UIUtilities
    {
        ...
        /// <summary>
        /// Executes the specified action on the UI thread of the given control.
        /// If the caller is already on the UI thread, the action is executed directly.
        /// </summary>
        /// <param name="control">The control whose UI thread the action should be executed on.</param>
        ...
        // Overloaded method for setting text property
        public static void ExecuteOnUIThread(this Control control, string text)
        {
            control.ExecuteOnUIThread(() => control.Text = text);
        }
    }
}
